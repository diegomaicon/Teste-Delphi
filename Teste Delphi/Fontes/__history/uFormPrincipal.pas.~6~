...
uses
  ...
  DBClient, uSaque, uRelatorioSaque, Vcl.Grids, Vcl.DBGrids, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param,
...
type
  TFrmPrincipal = class(TForm)
    ...
    DsNotas: TDataSource;
    FDSaqueTEmp: TFDMemTable;
    FDSaqueTEmpVALOR: TIntegerField;
    FDSaqueTEmpQUANTIDADE: TIntegerField;
    FDSaqueTEmpDESCRICAO: TStringField;
